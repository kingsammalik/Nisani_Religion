...
public class PlayerService extends Service implements
    ...
    private Status jcStatus = new Status();
    private List<PlayerView.JcPlayerViewServiceListener> jcPlayerServiceListeners;
    private List<PlayerView.OnInvalidPathListener> invalidPathListeners;
    private List<PlayerView.JcPlayerViewStatusListener> jcPlayerStatusListeners;
    private PlayerView.JcPlayerViewServiceListener notificationListener;
    ...
    public void registerInvalidPathListener(PlayerView.OnInvalidPathListener invalidPathListener) {
    ...
    public void pause(Audio jcAudio) {
        if (mediaPlayer != null) {
            mediaPlayer.pause();
        ...
        if(jcPlayerStatusListeners != null) {
            for (PlayerView.JcPlayerViewStatusListener jcPlayerStatusListener : jcPlayerStatusListeners) {
                ...
                jcStatus.setPlayState(Status.PlayState.PAUSE);
    ...
    private Audio tempJcAudio;
    public void play(Audio jcAudio) {
                        ...
                        if(tempJcAudio != jcAudio) {
                            ...
                            if (jcPlayerStatusListeners != null) {
                                for (PlayerView.JcPlayerViewStatusListener jcPlayerViewStatusListener : jcPlayerStatusListeners) {
                                    jcStatus.setJcAudio(jcAudio);
                                    jcStatus.setPlayState(Status.PlayState.PLAY);
    ...
    private void throwError(String path, Origin origin) {
        ...
        if (invalidPathListeners != null) {
            for (PlayerView.OnInvalidPathListener onInvalidPathListener : invalidPathListeners) {
